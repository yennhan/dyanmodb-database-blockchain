...
def receipt_pdf_generator(logo,receipt_id,company_name,company_address,purchaser,time1,the_list,account_id,company_claim):
    doc = SimpleDocTemplate(receipt_id + ".pdf", rightMargin=72, leftMargin=72,
    ...
    Story = []
    ptext = '<font size=12><b>%s</b><br/><br/></font>' % company_name
    ...
    if purchaser=="":
        ...
        ptext_3 = Paragraph(ptext3, styles['left'])
    ptext4="<font size=9><b>Receipt#   </b>     %s<br/><b>Receipt Date:  </b> %s<br/></font>" %(receipt_id,time1)
    ptext_4= Paragraph(ptext4,styles['left'])
    able = [['','',im],[ptext_1, '', ''],[ptext_2,'',''],['','',''],[ptext_3,'',ptext_4]]
    ...
    Story.append(Spacer(1, 11))
    if account_id == "":
        ptext = "<font size=9><b>Payment Details</b><br/>Cash</font>"
        ptext1 = Paragraph(ptext, styles['left'])
        Story.append(ptext1)
    else:
        ptext = "<font size=9><u><b>Payment Details</b></u><br/><br/>Claim Under Account ID: %s<br/> Company: %s</font>" % (
        account_id, company_claim)
        ptext1 = Paragraph(ptext, styles['left'])
        Story.append(ptext1)
    Story.append(Spacer(1, 11))
    Story.append(line)
    ...
    Story.append(ptext1)
    ptext = '<font size=9>**************** Official Receipt ****************</font>'
    ptext1 = Paragraph(ptext, styles['Center'])
    Story.append(ptext1)
    Story.append(Spacer(1, 11))
    Story.append(line)
...
#receipt_pdf_generator("test","Best Dengki Sdn Bhd","455, Amsterdam Avenue<br/>Petaling Jaya, 47400,<br/> Selangor Dahrul Ehsan",purchaser,time1,the_list,account_id,company_claim)